...
public class GUI6 extends AbstractIntegerProblem {
     ...
     * @throws IOException 
     */
    public GUI6(int m) throws IOException {
     ...
     // Initial Vertices (States)
        String[] initStates = {"m_inputlayercombobox", "m_gpmtoolbutton", "m_attrlinkcombobox", "m_gpmlineedit", "m_attreventcombobox", "m_attrpopcombobox", "m_ratecombobox", "m_repositorylineedit", "m_targetfiletoolbutton", "m_targetdatasourcetoolbutton", "m_newlayernamelineedit"};
        ...
        directedGraph.addEdge("m_gpmtoolbutton", "m_attreventcombobox");
        directedGraph.addEdge("m_gpmtoolbutton", "m_attrpopcombobox");
        directedGraph.addEdge("m_gpmtoolbutton", "m_ratecombobox");
        ...
        directedGraph.addEdge("m_attrlinkcombobox", "m_attreventcombobox");
        directedGraph.addEdge("m_attrlinkcombobox", "m_attrpopcombobox");
        directedGraph.addEdge("m_attrlinkcombobox", "m_ratecombobox");
        ...
        directedGraph.addEdge("m_gpmlineedit", "m_attreventcombobox");
        directedGraph.addEdge("m_gpmlineedit", "m_attrpopcombobox");
        directedGraph.addEdge("m_gpmlineedit", "m_ratecombobox");
        ...
        directedGraph.addEdge("m_attreventcombobox", "m_gpmtoolbutton");
        directedGraph.addEdge("m_attreventcombobox", "m_attrlinkcombobox");
        directedGraph.addEdge("m_attreventcombobox", "m_gpmlineedit");
        ...
        directedGraph.addEdge("m_attrpopcombobox", "m_gpmtoolbutton");
        directedGraph.addEdge("m_attrpopcombobox", "m_attrlinkcombobox");
        directedGraph.addEdge("m_attrpopcombobox", "m_gpmlineedit");
        ...
        directedGraph.addEdge("m_ratecombobox", "m_gpmtoolbutton");
        directedGraph.addEdge("m_ratecombobox", "m_attrlinkcombobox");
        directedGraph.addEdge("m_ratecombobox", "m_gpmlineedit");
