 ...
 */
public class MAC1 extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    public MAC1(int m) {
        ...
        setNumberOfObjectives(m); // {f1 = min roughness; f2 = max integrity; f3 = max tool life; f4 = max metal removal}
