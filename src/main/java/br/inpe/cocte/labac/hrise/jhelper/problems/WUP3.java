...
public class WUP3 extends AbstractIntegerProblem {
     ...
     * @throws IOException 
     */
    public WUP3(int m) throws IOException {
    	...
    	String selectPhoto = "selectPhoto";
    	
    	String addCaption = "addCaption";
    	...
    	directedGraph.addVertex(selectPhoto);
    	
    	directedGraph.addVertex(addCaption);
    	
    	directedGraph.addVertex(sendPhoto);
    	...
    	for (int i = 0; i < initStates.length; i++) {
          ...
          directedGraph.addEdge(initStates[i], selectPhoto);
       	}
    		
    	directedGraph.addEdge(typeText, selectPhoto);
    	
    	directedGraph.addEdge(selectPhoto, addCaption);
    	
    	directedGraph.addEdge(addCaption, sendPhoto);
    	
    	directedGraph.addEdge(sendPhoto, typeTextAgain);
