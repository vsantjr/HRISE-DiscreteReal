...
public class WR5 extends AbstractDoubleProblem {
  ...
  public void evaluate(DoubleSolution solution)  {
   ...
   // fx[1] = 3000 * x[0] ;
    fx[1] = 305700 * 2289 * x[1] / Math.pow(0.06*2289, 0.65) ;
    fx[2] = 250 * 2289 * Math.exp(-39.75*x[1]+9.9*x[2]+2.74) ;
    fx[3] = 25 * (1.39 /(x[0]*x[1]) + 4940*x[2] -80) ;
