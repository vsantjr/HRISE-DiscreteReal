...
public class GUI3 extends AbstractIntegerProblem {
     ...
     * @throws IOException 
     */
    public GUI3(int m) throws IOException {
        ...
        String[] initStates = {"m_layerscombobox", "m_importpushbutton", "m_minvaluelineedit", "m_maxvaluelineedit", "m_transformcombobox", "m_slicesspinbox", "m_typecombobox", "m_precisionspinbox", "m_bandcombobox", "m_loadlegendpushbutton", "m_savelegendpushbutton"};
        ...
        directedGraph.addVertex("m_minvaluelineedit");
        directedGraph.addVertex("m_maxvaluelineedit");
        directedGraph.addVertex("m_transformcombobox");
        directedGraph.addVertex("m_slicesspinbox");
        directedGraph.addVertex("m_typecombobox");
        directedGraph.addVertex("m_precisionspinbox");
        ...
        directedGraph.addEdge("m_layerscombobox", "m_minvaluelineedit");
        directedGraph.addEdge("m_layerscombobox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_layerscombobox", "m_transformcombobox");
        directedGraph.addEdge("m_layerscombobox", "m_slicesspinbox");
        directedGraph.addEdge("m_layerscombobox", "m_typecombobox");
        directedGraph.addEdge("m_layerscombobox", "m_precisionspinbox");
        directedGraph.addEdge("m_layerscombobox", "m_bandcombobox");
        ...
        directedGraph.addEdge("m_importpushbutton", "m_minvaluelineedit");
        directedGraph.addEdge("m_importpushbutton", "m_maxvaluelineedit");
        directedGraph.addEdge("m_importpushbutton", "m_transformcombobox");
        directedGraph.addEdge("m_importpushbutton", "m_slicesspinbox");
        directedGraph.addEdge("m_importpushbutton", "m_typecombobox");
        directedGraph.addEdge("m_importpushbutton", "m_precisionspinbox");
        directedGraph.addEdge("m_importpushbutton", "m_bandcombobox");
        ...
        directedGraph.addEdge("m_minvaluelineedit", "m_layerscombobox");
        directedGraph.addEdge("m_minvaluelineedit", "m_importpushbutton");
        directedGraph.addEdge("m_minvaluelineedit", "m_minvaluelineedit");
        directedGraph.addEdge("m_minvaluelineedit", "m_maxvaluelineedit");
        directedGraph.addEdge("m_minvaluelineedit", "m_transformcombobox");
        directedGraph.addEdge("m_minvaluelineedit", "m_slicesspinbox");
        directedGraph.addEdge("m_minvaluelineedit", "m_typecombobox");
        directedGraph.addEdge("m_minvaluelineedit", "m_precisionspinbox");
        directedGraph.addEdge("m_minvaluelineedit", "m_bandcombobox");
        directedGraph.addEdge("m_minvaluelineedit", "m_applypushbutton");
        directedGraph.addEdge("m_minvaluelineedit", "m_loadlegendpushbutton");
        directedGraph.addEdge("m_minvaluelineedit", "m_savelegendpushbutton");
        directedGraph.addEdge("m_maxvaluelineedit", "m_layerscombobox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_importpushbutton");
        directedGraph.addEdge("m_maxvaluelineedit", "m_minvaluelineedit");
        directedGraph.addEdge("m_maxvaluelineedit", "m_maxvaluelineedit");
        directedGraph.addEdge("m_maxvaluelineedit", "m_transformcombobox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_slicesspinbox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_typecombobox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_precisionspinbox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_bandcombobox");
        directedGraph.addEdge("m_maxvaluelineedit", "m_applypushbutton");
        directedGraph.addEdge("m_maxvaluelineedit", "m_loadlegendpushbutton");
        directedGraph.addEdge("m_maxvaluelineedit", "m_savelegendpushbutton");
        directedGraph.addEdge("m_transformcombobox", "m_layerscombobox");
        directedGraph.addEdge("m_transformcombobox", "m_importpushbutton");
        directedGraph.addEdge("m_transformcombobox", "m_minvaluelineedit");
        directedGraph.addEdge("m_transformcombobox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_transformcombobox", "m_transformcombobox");
        directedGraph.addEdge("m_transformcombobox", "m_slicesspinbox");
        directedGraph.addEdge("m_transformcombobox", "m_typecombobox");
        directedGraph.addEdge("m_transformcombobox", "m_precisionspinbox");
        directedGraph.addEdge("m_transformcombobox", "m_bandcombobox");
        directedGraph.addEdge("m_transformcombobox", "m_applypushbutton");
        directedGraph.addEdge("m_transformcombobox", "m_loadlegendpushbutton");
        directedGraph.addEdge("m_transformcombobox", "m_savelegendpushbutton");
        directedGraph.addEdge("m_slicesspinbox", "m_layerscombobox");
        directedGraph.addEdge("m_slicesspinbox", "m_importpushbutton");
        directedGraph.addEdge("m_slicesspinbox", "m_minvaluelineedit");
        directedGraph.addEdge("m_slicesspinbox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_slicesspinbox", "m_transformcombobox");
        directedGraph.addEdge("m_slicesspinbox", "m_slicesspinbox");
        directedGraph.addEdge("m_slicesspinbox", "m_typecombobox");
        directedGraph.addEdge("m_slicesspinbox", "m_precisionspinbox");
        directedGraph.addEdge("m_slicesspinbox", "m_bandcombobox");
        ...
        directedGraph.addEdge("m_typecombobox", "m_minvaluelineedit");
        directedGraph.addEdge("m_typecombobox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_typecombobox", "m_transformcombobox");
        directedGraph.addEdge("m_typecombobox", "m_slicesspinbox");
        directedGraph.addEdge("m_typecombobox", "m_typecombobox");
        directedGraph.addEdge("m_typecombobox", "m_precisionspinbox");
        ...
        directedGraph.addEdge("m_precisionspinbox", "m_layerscombobox");
        directedGraph.addEdge("m_precisionspinbox", "m_importpushbutton");
        directedGraph.addEdge("m_precisionspinbox", "m_minvaluelineedit");
        directedGraph.addEdge("m_precisionspinbox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_precisionspinbox", "m_transformcombobox");
        directedGraph.addEdge("m_precisionspinbox", "m_slicesspinbox");
        directedGraph.addEdge("m_precisionspinbox", "m_typecombobox");
        directedGraph.addEdge("m_precisionspinbox", "m_precisionspinbox");
        directedGraph.addEdge("m_precisionspinbox", "m_bandcombobox");
        directedGraph.addEdge("m_precisionspinbox", "m_applypushbutton");
        directedGraph.addEdge("m_precisionspinbox", "m_loadlegendpushbutton");
        directedGraph.addEdge("m_precisionspinbox", "m_savelegendpushbutton");
        directedGraph.addEdge("m_bandcombobox", "m_layerscombobox");
        directedGraph.addEdge("m_bandcombobox", "m_importpushbutton");
        directedGraph.addEdge("m_bandcombobox", "m_minvaluelineedit");
        directedGraph.addEdge("m_bandcombobox", "m_maxvaluelineedit");
        directedGraph.addEdge("m_bandcombobox", "m_transformcombobox");
        directedGraph.addEdge("m_bandcombobox", "m_slicesspinbox");
        directedGraph.addEdge("m_bandcombobox", "m_typecombobox");
        directedGraph.addEdge("m_bandcombobox", "m_precisionspinbox");
        directedGraph.addEdge("m_bandcombobox", "m_bandcombobox");
        directedGraph.addEdge("m_bandcombobox", "m_applypushbutton");
        directedGraph.addEdge("m_bandcombobox", "m_loadlegendpushbutton");
        directedGraph.addEdge("m_bandcombobox", "m_savelegendpushbutton");
        ...
        directedGraph.addEdge("m_loadlegendpushbutton", "m_minvaluelineedit");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_maxvaluelineedit");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_transformcombobox");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_slicesspinbox");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_typecombobox");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_precisionspinbox");
        directedGraph.addEdge("m_loadlegendpushbutton", "m_bandcombobox");
        ...
        directedGraph.addEdge("m_savelegendpushbutton", "m_minvaluelineedit");
        directedGraph.addEdge("m_savelegendpushbutton", "m_maxvaluelineedit");
        directedGraph.addEdge("m_savelegendpushbutton", "m_transformcombobox");
        directedGraph.addEdge("m_savelegendpushbutton", "m_slicesspinbox");
        directedGraph.addEdge("m_savelegendpushbutton", "m_typecombobox");
        directedGraph.addEdge("m_savelegendpushbutton", "m_precisionspinbox");
        directedGraph.addEdge("m_savelegendpushbutton", "m_bandcombobox");
